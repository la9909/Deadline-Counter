...
### 🏃 Sprint 6: AI 우선순위 자동 분석 & 위험도(Urgency) 시각화
> **목표:** 마감일(D-Day)과 과제 성격을 종합하여 시급성(Urgency Score)과 우선순위 뱃지(CRITICAL/HIGH/MEDIUM/LOW)를 시각화하고 긴급 과제를 강조

#### 6.1 Deliverables (산출물)
* [x] D-Day 임박도 및 마감일에 따른 4단계 긴급도/우선순위 뱃지 시스템 구축
* [x] D-Day 위험도 인디케이터 및 시각적 게이지(Urgency Progress Bar) UI 구현
* [x] 긴급 과제 상단 하이라이트 및 실시간 카운트다운 펄스 애니메이션

---

### 🏃 Sprint 7: AI 실행 체크리스트 인터랙션 & 진행률(Progress Tracker)
> **목표:** Gemini AI가 생성한 3단계 체크리스트를 사용자가 직접 체크하고 과제 달성률(%)을 실시간 추적

#### 7.1 Deliverables (산출물)
* [x] 과제 카드별 AI 생성 체크리스트의 인터랙티브 체크박스 상태 관리 (`completedSteps` State)
* [x] 실시간 진행률(0% ~ 100%) 프로그레스 바 및 완료 축하 배지 UI
* [x] 100% 완료 시 마감 스트레스 해소 축하 메시지 및 시각 피드백

---

### 🏃 Sprint 8: 스마트 필터링/검색 & 다크/라이트 테마 모드 지원
> **목표:** 과제 검색, 정렬 필터(임박순/우선순위순/이름순) 및 고품질 다크/라이트 테마 전환 기능 완성

#### 8.1 Deliverables (산출물)
* [x] 과제 실시간 검색창 및 탭 필터(전체 / D-Day 긴급 / 여유 / 완료)
* [x] 다크/라이트 모드 테마 스위치 및 세련된 Glassmorphism 디자인 고도화
* [x] 전체 시스템 통합 QA 및 빌드 검증
...
1. **스프린트 진행 방법:**
   ...
   - 스프린트 완료 시마다 터미널에 시각화된 진행 보고서를 출력하고 Git 커밋을 진행합니다.
2. **문서 유지관리:**
